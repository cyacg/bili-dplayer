!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("cyloli", [], t) : "object" == typeof exports ? exports.cyloli = t() : e.cyloli = t()
    ...
    , function(e, t, n) {
        ...
        console.log('%cwww.cyloli.com', 'font-size:2em');
        ...
        var o = function() {
          ...
          , Y = function() {
            function e(t) {
                ...
                this.container.classList.add("cyloli"),
                this.options.danmaku || this.container.classList.add("cyloli-no-danmaku"),
                this.options.live && this.container.classList.add("cyloli-live"),
                c.default.isMobile && this.container.classList.add("cyloli-mobile"),
                this.arrow = this.container.offsetWidth <= 500,
                this.arrow && this.container.classList.add("cyloli-arrow"),
            ...
            return o(e, [{
                ...
                value: function() {
                    ...
                    this.container.classList.remove("cyloli-paused"),
                    this.container.classList.add("cyloli-playing"),
                ...
                value: function() {
                    this.paused = !0,
                    this.container.classList.remove("cyloli-loading"),
                    ...
                    this.container.classList.remove("cyloli-playing"),
                    this.container.classList.add("cyloli-paused"),
                        ...
                        case "webtorrent":
                            if (WebTorrent)
                                if (WebTorrent.WEBRTC_SUPPORT) {
                                    this.container.classList.add("cyloli-loading");
                                    ...
                                    o.add(s, function(e) {
                                        e.files.find(function(e) {
                                            ...
                                            n.container.classList.remove("cyloli-loading")
                                        })
                                    })
                                } else
                    ...
                    if (this.qualityIndex !== e && !this.switchingQuality) {
                        ...
                        this.on("canplay", function() {
                            if (t.prevVideo) {
                                ...
                                t.video.classList.add("cyloli-video-current"),
                                n || t.video.play(),
                                t.prevVideo = null,
    ...
    , function(e, t, n) {
        ...
        t.default = function(e) {
            var t = {
                container: e.element || document.getElementsByClassName("cyloli")[0],
                live: !1,
                autoplay: !1,
                theme: "#b7daff",
                loop: !1,
    ...
    , function(e, t, n) {
        ...
        var a = {
            "zh-cn": {
                ...
                "About author": "\u5173\u4e8e\u4f5c\u8005",
                "cyloli feedback": "\u64ad\u653e\u5668\u610f\u89c1\u53cd\u9988",
                "About cyloli": "\u5173\u4e8e cyloli \u64ad\u653e\u5668",
                Loop: "\u6d17\u8111\u5faa\u73af",
                Speed: "\u901f\u5ea6",
            ...
            "zh-tw": {
                ...
                "About author": "\u95dc\u65bc\u4f5c\u8005",
                "cyloli feedback": "\u64ad\u653e\u5668\u610f\u898b\u53cd\u994b",
                "About cyloli": "\u95dc\u65bc cyloli \u64ad\u653e\u5668",
                Loop: "\u5faa\u74b0\u64ad\u653e",
                Speed: "\u901f\u5ea6",
          ...
          , u = function() {
            ...
            return o(e, [{
                ...
                value: function() {
                    ...
                    this.volumeBar = this.container.querySelector(".cyloli-volume-bar-inner"),
                    this.volumeBarWrap = this.container.querySelector(".cyloli-volume-bar"),
                    this.volumeBarWrapWrap = this.container.querySelector(".cyloli-volume-bar-wrap"),
                    this.volumeButton = this.container.querySelector(".cyloli-volume"),
                    this.volumeIcon = this.container.querySelector(".cyloli-volume-icon .cyloli-icon-content"),
                    this.playedBar = this.container.querySelector(".cyloli-played"),
                    this.loadedBar = this.container.querySelector(".cyloli-loaded"),
                    this.playedBarWrap = this.container.querySelector(".cyloli-bar-wrap"),
                    this.playedBarTime = this.container.querySelector(".cyloli-bar-time"),
                    this.danmaku = this.container.querySelector(".cyloli-danmaku"),
                    this.danmakuLoading = this.container.querySelector(".cyloli-danloading"),
                    this.video = this.container.querySelector(".cyloli-video-current"),
                    this.bezel = this.container.querySelector(".cyloli-bezel-icon"),
                    this.playButton = this.container.querySelector(".cyloli-play-icon"),
                    this.videoWrap = this.container.querySelector(".cyloli-video-wrap"),
                    this.controllerMask = this.container.querySelector(".cyloli-controller-mask"),
                    this.ptime = this.container.querySelector(".cyloli-ptime"),
                    this.settingButton = this.container.querySelector(".cyloli-setting-icon"),
                    this.settingBox = this.container.querySelector(".cyloli-setting-box"),
                    this.mask = this.container.querySelector(".cyloli-mask"),
                    this.loop = this.container.querySelector(".cyloli-setting-loop"),
                    this.loopToggle = this.container.querySelector(".cyloli-setting-loop .cyloli-toggle-setting-input"),
                    this.showDanmaku = this.container.querySelector(".cyloli-setting-showdan"),
                    this.showDanmakuToggle = this.container.querySelector(".cyloli-showdan-setting-input"),
                    this.unlimitDanmaku = this.container.querySelector(".cyloli-setting-danunlimit"),
                    this.unlimitDanmakuToggle = this.container.querySelector(".cyloli-danunlimit-setting-input"),
                    this.speed = this.container.querySelector(".cyloli-setting-speed"),
                    this.speedItem = this.container.querySelectorAll(".cyloli-setting-speed-item"),
                    this.danmakuOpacityBar = this.container.querySelector(".cyloli-danmaku-bar-inner"),
                    this.danmakuOpacityBarWrap = this.container.querySelector(".cyloli-danmaku-bar"),
                    this.danmakuOpacityBarWrapWrap = this.container.querySelector(".cyloli-danmaku-bar-wrap"),
                    this.danmakuOpacityBox = this.container.querySelector(".cyloli-setting-danmaku"),
                    this.dtime = this.container.querySelector(".cyloli-dtime"),
                    this.controller = this.container.querySelector(".cyloli-controller"),
                    this.commentInput = this.container.querySelector(".cyloli-comment-input"),
                    this.commentButton = this.container.querySelector(".cyloli-comment-icon"),
                    this.commentSettingBox = this.container.querySelector(".cyloli-comment-setting-box"),
                    this.commentSettingButton = this.container.querySelector(".cyloli-comment-setting-icon"),
                    this.commentSettingFill = this.container.querySelector(".cyloli-comment-setting-icon path"),
                    this.commentSendButton = this.container.querySelector(".cyloli-send-icon"),
                    this.commentSendFill = this.container.querySelector(".cyloli-send-icon path"),
                    this.commentColorSettingBox = this.container.querySelector(".cyloli-comment-setting-color"),
                    this.browserFullButton = this.container.querySelector(".cyloli-full-icon"),
                    this.webFullButton = this.container.querySelector(".cyloli-full-in-icon"),
                    this.menu = this.container.querySelector(".cyloli-menu"),
                    this.menuItem = this.container.querySelectorAll(".cyloli-menu-item"),
                    this.qualityList = this.container.querySelector(".cyloli-quality-list"),
                    this.camareButton = this.container.querySelector(".cyloli-camera-icon"),
                    this.subtitleButton = this.container.querySelector(".cyloli-subtitle-icon"),
                    this.subtitleButtonInner = this.container.querySelector(".cyloli-subtitle-icon .cyloli-icon-content"),
                    this.subtitle = this.container.querySelector(".cyloli-subtitle"),
                    this.qualityButton = this.container.querySelector(".cyloli-quality-icon"),
                    this.barPreview = this.container.querySelector(".cyloli-bar-preview"),
                    this.barWrap = this.container.querySelector(".cyloli-bar-wrap"),
                    this.notice = this.container.querySelector(".cyloli-notice"),
                    this.infoPanel = this.container.querySelector(".cyloli-info-panel"),
                    this.infoPanelClose = this.container.querySelector(".cyloli-info-panel-close"),
                    this.infoVersion = this.container.querySelector(".cyloli-info-panel-item-version .cyloli-info-panel-item-data"),
                    this.infoFPS = this.container.querySelector(".cyloli-info-panel-item-fps .cyloli-info-panel-item-data"),
                    this.infoType = this.container.querySelector(".cyloli-info-panel-item-type .cyloli-info-panel-item-data"),
                    this.infoUrl = this.container.querySelector(".cyloli-info-panel-item-url .cyloli-info-panel-item-data"),
                    this.infoResolution = this.container.querySelector(".cyloli-info-panel-item-resolution .cyloli-info-panel-item-data"),
                    this.infoDuration = this.container.querySelector(".cyloli-info-panel-item-duration .cyloli-info-panel-item-data"),
                    this.infoDanmakuId = this.container.querySelector(".cyloli-info-panel-item-danmaku-id .cyloli-info-panel-item-data"),
                    this.infoDanmakuApi = this.container.querySelector(".cyloli-info-panel-item-danmaku-api .cyloli-info-panel-item-data"),
                    this.infoDanmakuAmount = this.container.querySelector(".cyloli-info-panel-item-danmaku-amount .cyloli-info-panel-item-data")
                }
            }]),
            e
        }();
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.$value,
            e.$index;
            return t += '<div id="loading-box"><div class="loading"><p class="pic"></p><div class="tips"></div></div><div type="button" id="close" ><span id="link1">播放器已连接</span><span id="link2">弹幕正在连接中</span><span id="link2-success">弹幕已填装完毕</span><span id="link2-error">弹幕连接失败</span><span id="link3"><e id="link3_tip">等待视频连接中</e><!--d class="wait"><e id="span">3</e>s</d--></span></div></div><div class="cyloli-mask"></div>\n<div class="cyloli-cplayer"><div class="cyloli-showing"><svg aria-hidden="true"><use xlink:href="#icon-play"></use></svg></div></div><div class="cyloli-video-wrap">\n    ',
            function(e) {
                t += e
            }(n(4)(a)),
            t += "\n    ",
            o.logo && (t += '\n    <div class="cyloli-logo">\n        <img src="',
            t += s(o.logo),
            t += '">\n    </div>\n    '),
            t += '\n    <div class="cyloli-danmaku"',
            o.danmaku && o.danmaku.bottm && (t += ' style="margin-bottom:',
            t += s(o.danmaku.bottm),
            t += '"'),
            t += '>\n        <div class="cyloli-danmaku-item cyloli-danmaku-item--demo"></div>\n    </div>\n    <div class="cyloli-subtitle"></div>\n    <div class="cyloli-bezel">\n        <span class="cyloli-bezel-icon"></span>\n        ',
            o.danmaku && (t += '\n        <span class="cyloli-danloading">',
            t += s(r("Danmaku is loading")),
            t += "</span>\n        "),
            t += '\n        <span class="diplayer-loading-icon">',
            t += l.loading,
            t += '</span>\n    </div>\n</div>\n<div class="cyloli-controller-mask"></div>\n<div class="cyloli-controller">\n  <div class="controller-box">\n   <div class="cyloli-icons cyloli-icons-left">\n        <button class="cyloli-icon cyloli-play-icon">\n            <span class="cyloli-icon-content">',
            t += l.play,
            t += '</span>\n        </button>\n    <button onclick="video_next();" class="cyloli-icon  icon-xj" data-balloon="下一集" data-balloon-pos="up">\n<span class="cyloli-icon-content"><svg aria-hidden="true" fill="#fff"><use xlink:href="#icon-play-xj"></use></svg></span></button>\n    <div class="cyloli-volume">\n            <button class="cyloli-icon cyloli-volume-icon">\n                <span class="cyloli-icon-content">',
            t += l.volumeDown,
            t += '</span>\n            </button>\n            <div class="cyloli-volume-bar-wrap" data-balloon-pos="up">\n                <div class="cyloli-volume-bar">\n                    <div class="cyloli-volume-bar-inner" style="background: ',
            t += s(o.theme),
            t += ';">\n                        <span class="cyloli-thumb" style="background: ',
            t += s(o.theme),
            t += '"></span>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <span class="cyloli-time">\n            <span class="cyloli-ptime">0:00</span> /\n            <span class="cyloli-dtime">0:00</span>\n        </span>\n        ',
            o.live && (t += '\n        <span class="cyloli-live-badge"><span class="cyloli-live-dot" style="background: ',
            t += s(o.theme),
            t += ';"></span>',
            t += s(r("Live")),
            t += "</span>\n        "),
            t += '\n    </div>\n    <div class="cyloli-icons cyloli-icons-right">\n        ',
            o.video.quality && (t += '\n        <div class="cyloli-quality">\n            <button class="cyloli-icon cyloli-quality-icon">',
            t += s(o.video.quality[o.video.defaultQuality].name),
            t += '</button>\n            <div class="cyloli-quality-mask">\n                <div class="cyloli-quality-list"></div>\n                ',
            u(o.video.quality, function(e, n) {
                t += '\n                    <div class="cyloli-quality-item" data-index="',
                t += s(n),
                t += '">',
                t += s(e.name),
                t += "</div>\n                "
            ...
            t += '" value="bottom">\n                    <span>',
            t += s(r("Bottom")),
            t += '</span>\n                </label>\n            </div>\n          <div class="cyloli-comment-setting-color">\n                <div class="cyloli-comment-setting-title">',
            t += s(r("Set danmaku color")),
            t += '</div>\n                <label>\n                    <input type="radio" name="cyloli-danmaku-color-',
            t += s(c),
            ...
            t += s(c),
            t += '" value="#FFFFFF" checked>\n                    <span style="background: #FFFFFF"></span>\n                </label>\n</div>\n                   </div>\n        <input class="cyloli-comment-input" type="text" placeholder="',
            t += s(r("Input danmaku, hit Enter")),
            t += '" maxlength="30">\n        <button class="cyloli-icon cyloli-send-icon" data-balloon="',
            t += s(r("Send")),
            t += '" data-balloon-pos="up">\n            <span class="cyloli-icon-content">',
            t += l.send,
            t += '</span>\n        </button>\n<input id="dmtext" dmtype="right" class="cy-cyloli-comment-input" type="text" placeholder="',
            t += s(r("Input danmaku, hit Enter")),
            t += '" maxlength="30">\n        <button class="cyloli-icon cy-cyloli-send-icon" data-balloon="',
            t += s(r("Send")),
            t += '" data-balloon-pos="up">发送  </button>\n   </div>\n  </div>\n<div class="cyloli-info-panel cyloli-info-panel-hide">\n    <div class="cyloli-info-panel-close">关闭</div>\n    <div class="cyloli-info-panel-item cyloli-info-panel-item-version">\n        <span class="cyloli-info-panel-item-title">\u64ad\u653e\u5668\u7248\u672c</span>\n        <span class="cyloli-info-panel-item-data"></span>\n    </div>\n    <div class="cyloli-info-panel-item cyloli-info-panel-item-fps">\n        <span class="cyloli-info-panel-item-title">\u64ad\u653e\u5668\u5e27\u7387</span>\n        <span class="cyloli-info-panel-item-data"></span>\n    </div>\n    <div class="cyloli-info-panel-item cyloli-info-panel-item-type">\n        <span class="cyloli-info-panel-item-title">\u89c6\u9891\u7c7b\u578b</span>\n        <span class="cyloli-info-panel-item-data"></span>\n    </div>\n    <div class="cyloli-info-panel-item cyloli-info-panel-item-url">\n        <span class="cyloli-info-panel-item-title">视频地址</span>\n        <span class="cyloli-info-panel-item-data"></span>\n    </div>\n    <div class="cyloli-info-panel-item cyloli-info-panel-item-resolution">\n        <span class="cyloli-info-panel-item-title">视频分辨率</span>\n        <span class="cyloli-info-panel-item-data"></span>\n    </div>\n    <div class="cyloli-info-panel-item cyloli-info-panel-item-duration">\n        <span class="cyloli-info-panel-item-title">视频时长</span>\n        <span class="cyloli-info-panel-item-data"></span>\n    </div>\n    ',
        ...
        : function(e) {
          ...
          , s = function() {
            ...
            return o(e, [{
                ...
                value: function(e) {
                    if (void 0 !== e) {
                        for (var t = this.container.getElementsByClassName("cyloli-danmaku-item"), n = 0; n < t.length; n++)
                            t[n].style.opacity = e;
                        this._opacity = e,
                    ...
                    if (this.showing) {
                        ...
                        for (var u = document.createDocumentFragment(), d = 0; d < e.length; d++)
                            !function(a) {
                                ...
                                o.classList.add("cyloli-danmaku-item"),
                                o.classList.add("cyloli-danmaku-" + e[a].type),
                                ...
                                r >= 0 && (o.classList.add("cyloli-danmaku-move"),
                                u.appendChild(o))
                            }(d);
                ...
                value: function(e) {
                    if (!this.context) {
                        var t = getComputedStyle(this.container.getElementsByClassName("cyloli-danmaku-item")[0], null);
                ...
                key: "resize",
                value: function() {
                    for (var e = this.container.offsetWidth, t = this.container.getElementsByClassName("cyloli-danmaku-item"), n = 0; n < t.length; n++)
          ...
          , r = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    case "web":
                        return this.player.container.classList.contains("cyloli-fulled")
                    }
                }
            }, {
                key: "request",
                value: function() {
                    ...
                    case "browser":
                        ...
                        break;
                    case "web":
                        this.player.container.classList.add("cyloli-fulled"),
                        document.body.classList.add("cyloli-web-fullscreen-fix"),
                ...
                value: function() {
                    ...
                    case "browser":
                        ...
                        break;
                    case "web":
                        this.player.container.classList.remove("cyloli-fulled"),
                        document.body.classList.remove("cyloli-web-fullscreen-fix"),
        ...
        var a = function() {
          ...
          , r = function() {
            function e(t) {
                i(this, e),
                this.storageName = {
                    opacity: "cyloli-danmaku-opacity",
                    volume: "cyloli-volume",
                    unlimited: "cyloli-danmaku-unlimited",
                    danmaku: "cyloli-danmaku-show",
                    subtitle: "cyloli-subtitle-show"
                },
                this.default = {
                    opacity: .7,
        ...
        var a = function() {
          ...
          , o = function() {
            ...
            return a(e, [{
                ...
                key: "show",
                value: function() {
                    this.container.classList.remove("cyloli-subtitle-hide"),
                    this.events.trigger("subtitle_show")
                }
            }, {
                key: "hide",
                value: function() {
                    this.container.classList.add("cyloli-subtitle-hide"),
                    this.events.trigger("subtitle_hide")
                }
            }, {
                key: "toggle",
                value: function() {
                    this.container.classList.contains("cyloli-subtitle-hide") ? this.show() : this.hide()
                }
            }]),
            e
        }();
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    this.loadingChecker = setInterval(function() {
                        ...
                        i || n !== t || e.player.video.paused || (e.player.container.classList.add("cyloli-loading"),
                        i = !0),
                        i && n > t && !e.player.video.paused && (e.player.container.classList.remove("cyloli-loading"),
                        i = !1),
                        t = n)
                    }, 100)
                }
          ...
          , o = function() {
            function e(t) {
                ...
                this.container.addEventListener("animationend", function() {
                    n.container.classList.remove("cyloli-bezel-transition")
                })
            }
            return a(e, [{
                key: "switch",
                value: function(e) {
                    ...
                    this.container.classList.add("cyloli-bezel-transition")
                }
            }]),
            e
        }();
            ...
            return o(e, [{
                ...
                value: function() {
                    var e = this
                      ...
                      , n = function n() {
                        document.removeEventListener(r.default.nameMap.dragEnd, n),
                        document.removeEventListener(r.default.nameMap.dragMove, t),
                        e.player.template.volumeButton.classList.remove("cyloli-volume-active")
                    };
                    ...
                    this.player.template.volumeBarWrapWrap.addEventListener(r.default.nameMap.dragStart, function() {
                        document.addEventListener(r.default.nameMap.dragMove, t),
                        document.addEventListener(r.default.nameMap.dragEnd, n),
                        e.player.template.volumeButton.classList.add("cyloli-volume-active")
                    }),
                ...
                value: function() {
                    ...
                    this.player.options.video.quality && this.player.template.qualityList.addEventListener("click", function(t) {
                        t.target.classList.contains("cyloli-quality-item") && e.player.switchQuality(t.target.dataset.index)
                    })
                }
            }, {
                ...
                value: function() {
                    ...
                    this.player.options.screenshot && this.player.template.camareButton.addEventListener("click", function() {
                        ...
                        e.player.template.camareButton.download = "cyloli.png",
                ...
                key: "show",
                value: function() {
                    this.player.container.classList.remove("cyloli-hide-controller")
                }
            }, {
                key: "hide",
                value: function() {
                    this.player.container.classList.add("cyloli-hide-controller"),
                ...
                key: "isShow",
                value: function() {
                    return !this.player.container.classList.contains("cyloli-hide-controller")
                }
            }, {
                key: "toggle",
                value: function() {
          ...
          , r = function() {
            function e(t) {
                ...
                this.player.template.speed.addEventListener("click", function() {
                    n.player.template.settingBox.classList.add("cyloli-setting-box-narrow"),
                    n.player.template.settingBox.classList.add("cyloli-setting-box-speed")
                });
                ...
                if (this.player.danmaku) {
                    ...
                    var o = function(e) {
                      ...
                      , r = function e() {
                        ...
                        n.player.template.danmakuOpacityBox.classList.remove("cyloli-setting-danmaku-active")
                    };
                    ...
                    this.player.template.danmakuOpacityBarWrapWrap.addEventListener(s.default.nameMap.dragStart, function() {
                        ...
                        n.player.template.danmakuOpacityBox.classList.add("cyloli-setting-danmaku-active")
                    })
                }
            }
            return a(e, [{
                ...
                value: function() {
                    var e = this;
                    this.player.template.settingBox.classList.remove("cyloli-setting-box-open"),
                    this.player.template.mask.classList.remove("cyloli-mask-show"),
                    setTimeout(function() {
                        e.player.template.settingBox.classList.remove("cyloli-setting-box-narrow"),
                        e.player.template.settingBox.classList.remove("cyloli-setting-box-speed")
                    }, 300),
                ...
                key: "show",
                value: function() {
                    this.player.template.settingBox.classList.add("cyloli-setting-box-open"),
                    this.player.template.mask.classList.add("cyloli-mask-show"),
        ...
        var a = function() {
          ...
          , o = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    this.player.controller.disableAutoHide = !0,
                    this.player.template.controller.classList.add("cyloli-controller-comment"),
                    this.player.template.mask.classList.add("cyloli-mask-show"),
                    this.player.container.classList.add("cyloli-show-controller"),
                    this.player.template.commentInput.focus()
                }
            }, {
                key: "hide",
                value: function() {
                    this.player.template.controller.classList.remove("cyloli-controller-comment"),
                    this.player.template.mask.classList.remove("cyloli-mask-show"),
                    this.player.container.classList.remove("cyloli-show-controller"),
                    this.player.controller.disableAutoHide = !1,
                    this.hideSetting()
                }
            }, {
                key: "showSetting",
                value: function() {
                    this.player.template.commentSettingBox.classList.add("cyloli-comment-setting-open")
                }
            }, {
                key: "hideSetting",
                value: function() {
                    this.player.template.commentSettingBox.classList.remove("cyloli-comment-setting-open")
                }
            }, {
                key: "toggleSetting",
                value: function() {
                    this.player.template.commentSettingBox.classList.contains("cyloli-comment-setting-open") ? this.hideSetting() : this.showSetting()
                }
            }, {
                key: "send",
                value: function() {
                    ...
                    this.player.danmaku.send({
                        ...
                        color: this.player.container.querySelector(".cyloli-comment-setting-color input:checked").value,
                        type: this.player.container.querySelector(".cyloli-comment-setting-type input:checked").value
                    }, function() {
        ...
        var o = function() {
          ...
          , s = function() {
            ...
            return o(e, [{
                key: "show",
                value: function(e, t) {
                    this.player.template.menu.classList.add("cyloli-menu-show");
                ...
                value: function() {
                    this.player.template.mask.classList.remove("cyloli-mask-show"),
                    this.player.template.menu.classList.remove("cyloli-menu-show"),
          ...
          , o = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    this.container.classList.remove("cyloli-info-panel-hide")
                }
            }, {
                key: "hide",
                value: function() {
                    ...
                    this.container.classList.add("cyloli-info-panel-hide")
                }
            }, {
                key: "triggle",
                value: function() {
                    this.container.classList.contains("cyloli-info-panel-hide") ? this.show() : this.hide()
                }
            }, {
                key: "update",
                value: function() {
